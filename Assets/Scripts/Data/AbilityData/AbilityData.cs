...
namespace Data.AbilityData {
    ...
    public class AbilityData : ScriptableObject {
        ...
        [SerializeField] public int areaOfEffectCircularRadius; // 0 (none), 100f, 200f
        [SerializeField] public int areaOfEffectRectangularWidth; // 0 (none), 100f, 200f
        ...
        [SerializeField] public AbilityTargetLocationSelectionType targetLocationSelectionType; // defines how the ability responds to user input
