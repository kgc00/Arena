...
namespace State.MeleeAiStates {
    public class AttackUnitState : UnitState {
        ...
        public override void Enter() {
            ...
            Owner.CoroutineHelper.StartCoroutine(HandleAttack());
        }

        private IEnumerator HandleAttack() {
            attackComplete = false;
            if (Owner.Animator == null && playerTransform == null) yield break;
            ...
            if (playerTransform != null)
                Owner.AbilityComponent.Activate(ref Owner.AbilityComponent.longestRangeAbility, playerTransform.position);
