...
namespace UI.InGameShop.AbilitiesScreen {
    public class SkillInspectorView : MonoBehaviour {
        ...
        private void OnEnable() {
            NotificationCenter.instance.AddObserver(HandleSkillScrollViewToggleToggledOn,
                NotificationType.SkillScrollViewToggleToggledOn);
        }

        private void OnDisable() {
            NotificationCenter.instance.RemoveObserver(HandleSkillScrollViewToggleToggledOn,
                NotificationType.SkillScrollViewToggleToggledOn);
        }
