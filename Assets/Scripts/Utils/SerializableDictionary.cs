...
namespace Utils
{
    ...
    {
        [SerializeField] public List<T1> Keys;
        [SerializeField] public List<T2> Values;
        
        [SerializeField] public Dictionary<T1, T2> Dictionary = new Dictionary<T1, T2>();
...
//                         "Enumerator version {0} != Dictionary version {1}", _Version, _Dictionary._Version));
//
